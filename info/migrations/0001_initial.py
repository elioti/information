# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-03-06 09:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('datetime', models.DateTimeField(auto_created=True, verbose_name='建立时间')),
                ...
                ('wechat', models.CharField(default='', max_length=32, verbose_name='微信')),
            ],
        ),
    ]
